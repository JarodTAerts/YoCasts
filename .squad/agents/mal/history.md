...
- **Immediate Actions:** (1) Kaylee: Add Background permission to manifest, (2) Jarod: Acquire Venu 4 hardware, (3) All: Review hardware testing plan (40+ cases, 5 days). Top risks documented. Phase C MVP = download + playback one episode (2-3 days code, 1-2 days hardware debug).
